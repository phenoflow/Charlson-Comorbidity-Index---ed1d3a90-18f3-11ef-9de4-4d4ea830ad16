...
(async () => {
  ...
  await fs.writeFile("charlson-comorbidity-index-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("charlson-comorbidity-index-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
